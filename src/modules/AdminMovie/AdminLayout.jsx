      ...
      <Layout className="site-layout">
        ...
        >
          ...
          >
            ...
            <button onClick={() => movePath('movies/add')} className="btn-style mb-3" style={{ width: "160px" }}>
              Thêm Phim
            </button>
            <form>
              <div className="mb-3">
                ...
                return (
                  <tbody key={movie.maPhim}>
                    <tr>
                        ...
                        <td>
                            <button onClick={() => handleEditMovie(movie)} className="fs-5"><AiOutlineEdit/></button>
                            <button onClick={() => handleDeleteMovie(movie.maPhim)} className="px-2 fs-5"><AiOutlineDelete/></button>
                            <button onClick={() => movePath("movies/showtime")} className="fs-5"><AiOutlineCalendar/></button>
                        </td>
                    </tr>
